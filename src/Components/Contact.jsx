const Contact = () => {
  return (
    <div className="max-w-[1200px] mx-auto  sm:py-20 p-5" name="Contact">
      ...
      <div className="max-w-[800px] mx-auto">
        <div className="mt-6 bg-[#161616] rounded-xl">
          <div className="p-10">
            <form action="https://getform.io/f/panroxea" method="POST">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                ...
                <div className="sm:col-span-2">
                  <button
                    type="submit"
                    className="text-xl w-full p-4 mt-2 font-semibold text-white bg-primary-color rounded-sm"
                  >
                    Send
                  </button>
                </div>
